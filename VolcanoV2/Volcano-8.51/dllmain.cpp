...
DWORD Main(LPVOID)
{
    ...
    *BYTE = 0x74;
    ...
    // Load building items for bots
    Wall = StaticLoadObject<UFortWorldItemDefinition>("/Game/Items/Weapons/BuildingTools/BuildingItemData_Wall.BuildingItemData_Wall");
    Floor = StaticLoadObject<UFortWorldItemDefinition>("/Game/Items/Weapons/BuildingTools/BuildingItemData_Floor.BuildingItemData_Floor");
    Stair = StaticLoadObject<UFortWorldItemDefinition>("/Game/Items/Weapons/BuildingTools/BuildingItemData_Stair.BuildingItemData_Stair");
    Roof = StaticLoadObject<UFortWorldItemDefinition>("/Game/Items/Weapons/BuildingTools/BuildingItemData_RoofS.BuildingItemData_RoofS");
    EditTool = StaticLoadObject<UFortWorldItemDefinition>("/Game/Items/Weapons/BuildingTools/EditTool.EditTool");
    
    LOG_("Building items loaded!");
    
    // Hook bot system functions
    FortAIBotControllerAthena::HookAll();
    
    LOG_("Bot system initialized! Ready to spawn {} bots!", Globals::TotalBotsToSpawn);
