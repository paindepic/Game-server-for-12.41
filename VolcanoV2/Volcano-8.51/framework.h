...
// Global bot system variables
inline UAthenaNavSystem* AthenaNavSystem = nullptr;
inline TArray<AActor*> PlayerStarts{};
inline TArray<AActor*> BuildingFoundations{};
inline uintptr_t ImageBase = (uintptr_t)GetModuleHandleW(0);

inline UFortWorldItemDefinition* Wall = nullptr;
inline UFortWorldItemDefinition* Floor = nullptr;
inline UFortWorldItemDefinition* Stair = nullptr;
inline UFortWorldItemDefinition* Roof = nullptr;
inline UFortWorldItemDefinition* EditTool = nullptr;
