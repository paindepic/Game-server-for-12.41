...
namespace Information // Wehook ur needed here for server status
{
    /*uptime*/
    // https://discord.com/api/webhooks/1437901766925615266/I1kIFBG2GZRvmLV7EtYzmSXYrbTnX5tUtmiKuPdCS2QOTPLzGC-BKTxoKVIJL1a_u8xz
    static std::string UptimeWebHook = (""); // put any webhook ur here to get it to work!
}
